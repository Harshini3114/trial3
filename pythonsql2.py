...
if a == "yes" or a == "YES" or a=="Yes":
    ...
    if ques == "yes" or ques =="YES"or ques == "Yes":
        ...
        amount_paid=fare
        cursor.execute("INSERT INTO USER_DETAILS VALUES('{}','{}','{}','{}',{})".format(name,phno,email,address,amount_paid))
        cursor.execute("UPDATE SEAT_AVAILABILITY SET no_of_seats={} WHERE ID='{}'".format(SEAT,b))
        db.commit()
